...
type ThreatCardProps = {
  ...
  custom?: number; // For framer-motion custom prop
};
...
export default function ThreatCard({ threat, variants, custom }: ThreatCardProps) {
  ...
  return (
    <motion.div variants={variants} custom={custom} className="h-full">
      <Card className="shadow-xl hover:shadow-primary/60 transition-all duration-300 ease-in-out transform hover:-translate-y-1 bg-card border border-border overflow-hidden flex flex-col h-full">
